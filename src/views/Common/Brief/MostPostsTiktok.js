      ...
      <Box className='wrapper-grid' sx={{gridTemplateColumns: '1fr 1fr'}}>
        {_.map(data, (itm, idx) => (
          ...
          <Box key={idx} className='box-wrapper-shadow grid-item nopadding'>
            ...
            <Box sx={{display:'grid', gridTemplateColumns:'1fr 1fr 1fr'}} className='mgb5 mgt5'>
              <Box sx={{fontSize:'12px', display: 'flex', alignItems: 'center'}}>
                <svg fill="none" height="16" width="16" xmlns="http://www.w3.org/2000/svg" className="yt-posts-comp_iconSpace_13xIx">
