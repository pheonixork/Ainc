    ...
    <Box className='lastupdates'>
      <Box className='wrapper-grid' sx={{gridTemplateColumns: '1fr 1fr'}}>
        <Box className='box-wrapper-shadow grid-item' sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
          ...
          <Box className='subtitle'>{evaluateValue(data.profile.followers ?? 0)}</Box>
          <span className='subtitle-help'>加入者</span>
          <RoundInfo caption={'合計加入者数。'}/>
        </Box>
        <Box className='box-wrapper-shadow grid-item' sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
        ...
        <Box className='box-wrapper-shadow grid-item' sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
          ...
          <span className='subtitle-help'>平均ビュー</span>
          <RoundInfo caption={'平均ビュー数。'} />
        </Box>
        <Box className='box-wrapper-shadow grid-item' sx={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
          ...
          <Box className='subtitle'>{evaluateValue(0)}</Box>
          <span className='subtitle-help'>平均コメント</span>
          <RoundInfo caption='平均コメントー数。' />
        </Box>
      </Box>
    </Box>
  );
