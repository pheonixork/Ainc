    ...
    <Box className='mostposts'>
      ...
      <Box className='wrapper-grid' sx={{gridTemplateColumns: '1fr 1fr'}}>
        <Box className='box-wrapper-shadow grid-item nopadding'>
          ...
          >
            <RelativeImage 
              imgSrc={'https://imgigp.modash.io/v2?mb0KwpL92uYofJiSjDn1%2F6peL1lBwv3s%2BUvShHERlDYElzQ8azFJzmu%2FFSX2Dbh4IgMotO%2Fr3qoQg8ER303otSdJjHkZL1tYoNYNB3wZfOhNhXHQbsxyx2qO2VwkeouGWGfbnU6kynMhxBzdUwrN0g%3D%3D'}
            />
          </Box>
