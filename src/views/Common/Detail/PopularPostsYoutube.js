...
const PopularPostsYoutube = ({data, statHistory, recentPosts, hashtags, brandAffinity, interests, lookalikes}) => {
      ...
      <Box className='wrapper-grid' sx={{gridTemplateColumns: '1fr 1fr 1fr'}}>
        {_.map(data, (itm, idx) => (
          ...
          <Box key={idx} className='box-wrapper-shadow grid-item nopadding' sx={{maxWidth: '220px'}}>
            ...
            <Box sx={{display:'grid', gridTemplateColumns:'1fr 1fr'}} className='mgb5 mgt5'>
            ...
            <Box sx={{display:'grid', gridTemplateColumns:'1fr 1fr'}} className='mgb5 mgt5'>
              ...
              <Box className='mgr5 mgl5' sx={{fontSize:'12px', display: 'flex', alignItems: 'center'}}>
                <svg fill="none" height="16" viewBox="0 0 16 16" width="16" xmlns="http://www.w3.org/2000/svg" style={{marginRight:'.5rem'}}>
