...
export default function FltAudienceAges({ clearFlag, tip, icon, values, caption, setValues, ...rest }) {
  ...
  return (
    <Box className='flex-sub-wrapper'>
      <Box className='search-item-wrapper'>
        ...
        {itemValue.length > 0 && 
          <span className='clear' onClick={e=>setAges([])}>{Keyword.caption.clear}</span>
        }
      </Box>
      <Select 
        multiple
