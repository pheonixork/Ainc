...
export default function FltInfluencerInterest({ clearFlag, tip, icon, values, itmKey, itmValue, caption, setValues, ...rest }) {
  ...
  const setInterests = (value) => {
    ...
    setValues('interests', typeof value === 'string' ? value.split(',') : value);
  }
