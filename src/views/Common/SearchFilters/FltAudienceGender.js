...
export default function FltAudienceGender({ clearFlag, tip, icon, values, caption, setValues, ...rest }) {
  ...
  return (
    <Box className='flex-sub-wrapper'>
      <Box className='search-item-wrapper'>
        ...
        {itemValue !== '' && 
          <span className='clear' onClick={e=>setGenderValue('')} style={{color:theme.palette.clrVariables.cyanLight}}>{Keyword.caption.clear}</span>
        }
      </Box>
      <Select 
        value={itemValue}
